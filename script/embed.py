...
if __name__ == "__main__":
    ...
    # create schema
    properties = [
        wvc.Property(name="uuid", data_type=wvc.DataType.UUID, skip_vectorization=True, vectorize_property_name=False),
        wvc.Property(name="text", data_type=wvc.DataType.TEXT, skip_vectorization=False, vectorize_property_name=False),
    ]
